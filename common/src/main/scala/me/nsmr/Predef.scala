...
object FileUtil {
  ...
  def reading[A](is: InputStream)(body: Iterator[String] => A): A = reading(new InputStreamReader(is)) { body }

  def reading[A](is: InputStream, encode: String)(body: Iterator[String] => A): A = reading(new InputStreamReader(is, encode)) { body }

  def reading[A](file: File)(body: Iterator[String] => A): A = reading(new FileInputStream(file)) { body }

  def reading[A](file: File, encode: String)(body: Iterator[String] => A): A = reading(new FileInputStream(file), encode) { body }
  ...
  def writing[A](file: File, encode: String)(body: BufferedWriter => A): A = writing(new OutputStreamWriter(new FileOutputStream(file),encode)) { body }

  def writing[A](file: File)(body: BufferedWriter => A): A = writing(new OutputStreamWriter(new FileOutputStream(file))) { body }
  ...
  def appending[A](file: File, encoding: String)(body: BufferedWriter => A): A = writing(new OutputStreamWriter(new FileOutputStream(file, true))) { body }

  def appending[A](path: String, encode: String)(body: BufferedWriter => A): A = writing(new OutputStreamWriter(new FileOutputStream(path, true))) { body }
}
